...
reportCSV = "~/spark-bigquery/target/license-reports/spark-bigquery-licenses.csv"
# output README file
...
checkLicenseUrl <- function (licenseString) {
  ...
  if (is.na(url_parse(url)$scheme)) {
    stop("No valid URL found: ", licenseString)
  }
}
...
Sources for other open source software components can be obtained from the
corresponding project websites or source code repositories:
"
